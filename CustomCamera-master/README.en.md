...
│  │     ├──MetadataManager.ets                     // Metadata output stream.
...
│  ├──models             
│  │  └──CameraManagerModel.ets                     // Camera manager data class.
│  ├──pages             
...
│  └──views
│     ├──FuncButtonsView.ets                        // Camera Function Button View.
│     ├──ModeButtonsView.ets                        // Photo mode switch button view.  
│     ├──OperateButtonsView.ets                     // Operation button view.
│     ├──PreviewImageView.ets                       // Photo Preview View.
│     ├──PreviewScreenView.ets                      // Preview screen view.
